...
def DefineState(character):
    if character.isupper():
        ...
        return 5
    elif character.isalpha() and InsertedCommand[-1].Lexeme == '-f':
        return 6
    else:
        return 0
        ...
        if State == 1:
            ...
            if State != 1:
                if Buffer in Reserved:
                    NewToken = TokenObject('RESERVED', Buffer)
                    ...
                    NewToken = TokenObject('COND1', Buffer)
                    TokenList.append(NewToken)
                    InsertedCommand.append(NewToken)
                    NewToken.ShowToken()
                    Buffer = ''
                    ...
                    NewToken = TokenObject('COND2', Buffer)
                    TokenList.append(NewToken)
                    InsertedCommand.append(NewToken)
                    NewToken.ShowToken()
                    Buffer = ''
                    ...
                    NewToken = TokenObject('ERROR', Buffer)
...
def SyntacticAnalizer(command: list):
    ...
    if command[0].Lexeme == 'RESULTADO':
        ...
        if command[4] != None and command[4].Lexeme == '-n':
            if command[5].Type == 'NUM':
                SyntacticalApproved = True
            else:
                SyntacticalApproved = False
