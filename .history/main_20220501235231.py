    ...
    if CorrectSyntax and CorrectLexicon:
        ...
        if Comando[0].Lexeme == 'GOLES':
            ...
            if SubState1 == 1:
                ...
                temp = temp.replace('-',' ')
                mensaje = 'Los goles anotados por el {} en {} en la temporada {} fueron {}'.format(Comando[2].Lexeme, Comando[1.].Lexeme.lower() temp, Goles)
                SendMessage('BOT', mensaje)
                ...
                temp = str(Comando[4].Lexeme)
                temp = temp.replace('-',' ')
                mensaje = 'Los goles anotados por el {} en total en la temporada {} fueron {}'.format(Comando[2].Lexeme, temp, Goles)
                SendMessage('BOT', mensaje)
