...
def SyntacticAnalizer(command: list):
    ...
    if command[0].Lexeme == 'RESULTADO':
        if len(command) > 1 and command[1].Type == 'STR':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[1])
            SyntacticalApproved = False

        if len(command) > 2 and command[2].Lexeme == 'VS':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[2])
            SyntacticalApproved = False
        
        if len(command) > 3 and command[3].Type == 'STR':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[3])
            SyntacticalApproved = False
        
        if len(command) > 3 and command[4].Lexeme == 'TEMPORADA':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[4])
            SyntacticalApproved = False
        
        if len(command) > 4 and command[5].Type == 'TEMP':
            SyntacticalApproved = True
        else:
        ...
        if len(command) > 1 and command[1].Type == 'NUM':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[1])
            SyntacticalApproved = False

        if len(command) > 2 and command[2].Lexeme == 'TEMPORADA':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[2])
            SyntacticalApproved = False

        if len(command) > 3 and command[3].Type == 'TEMP':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[3])
            SyntacticalApproved = False

        if len(command) > 4 and command[4].Lexeme == '-f':
            SyntacticalApproved = True
        ...
        if len(command) > 1 and command[1].Type == 'COND1':
            SyntacticalApproved= True
        else:
            SyntacticalError.append(command[1])
            SyntacticalApproved = False

        if len(command) > 1 and command[2].Type == 'STR':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[2])
            SyntacticalApproved = False
        
        if len(command) > 3 and command[3].Lexeme == 'TEMPORADA':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[3])
            SyntacticalApproved = False
        
        if len(command) > 4 and command[4].Type == 'TEMP':
            SyntacticalApproved = True
        else:
            SyntacticalError.append(command[4])
            SyntacticalApproved = False
        ...
        if len(command) > 1 and command[1].Lexeme == 'TEMPORADA':
            SyntacticalApproved= True
        else:
            SyntacticalError.append(command[1])
            SyntacticalApproved = False
        
        if len(command) > 2 and command[2].Type == 'TEMP':
            SyntacticalApproved= True
        else:
            SyntacticalError.append(command[2])
            SyntacticalApproved = False

        if len(command) > 3 and command[3].Lexeme == '-f':
            SyntacticalApproved= True
        ...
        if len(command) > 6 and command[6].Lexeme == '-f':
        ...
        if len(command) > 1 and command[1].Type == 'COND2':
            SyntacticalApproved = True
        else:
            SyntacticalApproved = False
            SyntacticalError.append(command[1])
        ...
        if len(command) > 4 and command[4].Lexeme == '-n':
            if command[5].Type == 'NUM':
                SyntacticalApproved = True
            else:
                SyntacticalApproved = False
